...
EnergyAdaptiveMLPFunction ::EnergyAdaptiveMLPFunction()
{
...
// vectorised version
void
EnergyAdaptiveMLPFunction ::Evaluate(std::vector<double> u, std::vector<double> & x, std::vector<double> & y)
{
...
void
EnergyAdaptiveMLPFunction ::EvaluateError(const double u, itk::Matrix<double, 2, 2> & error)
{
