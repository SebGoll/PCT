...
SchulteMLPFunction ::SchulteMLPFunction()
{
                                   ...
                                   double           MaterialBudget)
{
  ...
  m_SigmaOut(1, 1) += (Functor::SchulteMLP::IntegralForSigmaSqTheta::GetValue(m_u2 + trackerThickness) -
                       Functor::SchulteMLP::IntegralForSigmaSqTheta::GetValue(m_u2)) *
                      c;
...
void
SchulteMLPFunction ::EvaluateError(const double u, itk::Matrix<double, 2, 2> & error)
{
  double x, y;
  double dx, dy;
...
void
SchulteMLPFunction ::InverseMatrix(itk::Matrix<double, 2, 2> & mat)
{
