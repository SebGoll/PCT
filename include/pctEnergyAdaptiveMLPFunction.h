...
public:
  static double
  GetA(const double uOut, itk::Vector<double, 2> ab)
  {
  ...
  static double
  GetB(const double uOut, itk::Vector<double, 2> ab)
  {
  ...
  static double
  GetC(const double uOut, itk::Vector<double, 2> ab)
  {
    double uOut_tilde = uOut * ab[0] / ab[1];
  ...
  static double
  GetD(const double uOut, itk::Vector<double, 2> ab)
  {
    double uOut_tilde = uOut * ab[0] / ab[1];
    double D = (0.5 * uOut_tilde * uOut_tilde + uOut_tilde - (uOut_tilde + 1) * std::log(uOut_tilde + 1)) *
               std::pow(ab[1], 2) / std::pow(ab[0], 3);
    return D;
  }
};
